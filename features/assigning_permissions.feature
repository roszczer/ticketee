Feature: Assigning permissions
  ...
  Scenario: Viewing a project
    When I check "View" for "subl"
    And I press "Update"
    And I follow "Sign out"

    Given I am signed in as "user@ticketee.com"
    Then I should see "subl"
    
  Scenario: Creating tickets for a project
    When I check "View" for "subl"
    When I check "Create tickets" for "subl"
    And I press "Update"
    And I follow "Sign out"
  ...
  Scenario: Updating a ticket for a project
    When I check "View" for "subl"
    And I check "Edit tickets" for "subl"
    And I press "Update"
    And I follow "Sign out"
  ...
  Scenario: Deleting a ticket for a project
    When I check "View" for "subl"
    And I check "Delete tickets" for "subl"
    And I press "Update"
    And I follow "Sign out"
